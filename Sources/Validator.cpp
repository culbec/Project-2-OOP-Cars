...
bool Validator::validateRegNumber(const Car& car) const {
	...
	if (regNumber.at(0) == 'B' && !(regNumber.at(1) >= 'A' && regNumber.at(1) <= 'Z')) {
		if (regNumber.size() == 7) {
			if ((regNumber.at(1) >= '1' && regNumber.at(1) <= '9') &&
				...
				if (!(regNumber.at(4) >= 'A' && regNumber.at(4) <= 'Z')) errors = errors + "Caracterul de pe pozitia 5 trebuie sa fie litera majuscula!\n";
				else if (!(regNumber.at(5) >= 'A' && regNumber.at(5) <= 'Z')) errors = errors + "Caracterul de pe pozitia 6 trebuie sa fie litera majuscula!\n";
				else if (!(regNumber.at(6) >= 'A' && regNumber.at(6) <= 'Z')) errors = errors + "Caracterul de pe pozitia 7 trebuie sa fie litera majuscula!\n";
			}
			else
			...
			if(!(regNumber.at(3) >= 'A' && regNumber.at(3) <= 'Z')) errors = errors + "'B' trebuie sa fie urmat de 2 cifre si 3 litere!\n";
			else if ((regNumber.at(1) >= '0' && regNumber.at(1) <= '9') && (regNumber.at(2) >= '0' && regNumber.at(2) <= '9')) { // avem numar de genul B100XYZ
				// numar de genul B10_YZ 
				if (!(regNumber.at(3) >= 'A' && regNumber.at(3) <= 'Z')) errors = errors + "Caracterul de pe pozitia 5 trebuie sa fie litera majuscula!\n";
				// numar de genul B10X_Z
				else if (!(regNumber.at(4) >= 'A' && regNumber.at(4) <= 'Z')) errors = errors + "Caracterul de pe pozitia 6 trebuie sa fie litera majuscula!\n";
				// numar de genul B10XY_ 
				else if (!(regNumber.at(5) >= 'A' && regNumber.at(5) <= 'Z')) errors = errors + "Caracterul de pe pozitia 7 trebuie sa fie litera majuscula!\n";
			}
...
bool Validator::validateProducer(const Car& car) const {
...
bool Validator::validateModel(const Car& car) const {
...
bool Validator::validateType(const Car& car) const {
